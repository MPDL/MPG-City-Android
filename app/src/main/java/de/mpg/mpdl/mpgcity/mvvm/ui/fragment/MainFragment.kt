...
class MainFragment : BaseFragment<MainViewModel>(), Scene.OnUpdateListener, View.OnClickListener {
    ...
    private fun initListCity(){
        ...
        cityItemList.add(CustomItem(R.id.item0,R.mipmap.city_map_0,-1,0,3,"https://www.youtube.com/watch?v=zZFyD8kSaIo",MainActivity.videoRatio))
        ...
        cityItemList.add(CustomItem(R.id.item6,R.mipmap.city_map_6,-2,0,"item_6_content.jpg",(848.0/565.0)))
        ...
        cityItemList.add(CustomItem(R.id.item9,R.mipmap.city_map_9,0,2,3,"https://www.youtube.com/watch?v=X2yDs5FHDok&feature=youtu.be",MainActivity.videoRatio))
        ...
        cityItemList.add(CustomItem(R.id.item14,R.mipmap.city_map_14,2,-2,"https://mpgcityweek.mpdl.mpg.de/gemeinsame-netzwerkzentrum-joint-network-centre/"))
...
//                    showNode(augmentedImage)
    ...
    private fun createImageDialog(item: CustomItem){
        if (imageDialog != null){
            imageDialog?.dismiss()
            imageDialog = null
        }
    ...
    private fun createVideoDialog(item: CustomItem){
        if (videoDialog != null){
            videoDialog?.dismiss()
            videoDialog = null
        }
